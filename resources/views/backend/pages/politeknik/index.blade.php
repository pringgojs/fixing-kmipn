...
<div class="row">
    <div class="col-sm-12">
        <div class="card">
            ...
            <a href="{{ url('/ecodeeepis/politeknik/create') }}" class="btn btn-success pull-right">Create New</a>
                        ...
                        <tr>
                            ...
                            <td width="153">
                                <form action="{{ url('/ecodeeepis/politeknik/'.$item->id) }}" method="post">
                                    ...
                                    <a href="{{ url('/ecodeeepis/politeknik/'.$item->id.'/edit') }}" class="btn btn-info"><i class="fa fa-pencil"></i> Edit</a>
